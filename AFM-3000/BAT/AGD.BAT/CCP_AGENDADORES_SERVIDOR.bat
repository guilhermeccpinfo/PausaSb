...
schtasks /create /tn "CCP_CLOUD" /tr "C:\AFM-3000\BAT\BKP\CCP_CLOUD.bat" /sc daily /mo 1 /st 01:30 /ru SYSTEM /RL HIGHEST /f
timeout /t 10
...
REM Criação da tarefa no Agendador de Tarefas
schtasks /create /tn "CCP_BKP_SERVIDOR" /tr "cmd /c start /min C:\AFM-3000\BAT\BKP\CCP_SERVIDOR.bat" /sc daily /st 03:00 /f
timeout /t 10
