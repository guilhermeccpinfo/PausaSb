...
xcopy "C:\AFM-3000\BAT\EXECUTAR\FTP SERVIDOR\CCP_FTP_MATRIZ_SERV.vbs" "%appdata%\Microsoft\Windows\Start Menu\Programs\Startup" /y

REM Definir os caminhos do arquivo .bat no servidor C:
set "bat1_path=C:\AFM-3000\BAT\FTP\BAT_FTP\FTP_MATRIZ.bat"
...
schtasks /create /tn "CCP_FTP_MATRIZ" /tr "C:\AFM-3000\BAT\FTP\BAT_FTP\FTP_MATRIZ.vbs" /sc hourly /st 00:00 /RL HIGHEST /f
