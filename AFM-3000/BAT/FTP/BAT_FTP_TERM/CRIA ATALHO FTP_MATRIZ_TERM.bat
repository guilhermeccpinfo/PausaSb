...
xcopy "C:\AFM-3000\BAT\EXECUTAR\FTP TERMINAL\CCP_FTP_MATRIZ_TERM.vbs" "%appdata%\Microsoft\Windows\Start Menu\Programs\Startup" /y

REM Definir os caminhos do arquivo .bat no servidor C:
set "bat1_path=Z:\AFM-3000\BAT\FTP\BAT_FTP\FTP_MATRIZ.bat"
