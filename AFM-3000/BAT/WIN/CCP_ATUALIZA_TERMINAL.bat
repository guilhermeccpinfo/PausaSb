...
del /F /Q "C:\AFM-3000\BAT\*.*" >nul 2>&1

set "origem=Z:\AFM-3000\BAT"
set "destino=C:\AFM-3000\BAT"

REM Copiando arquivos...
xcopy "%origem%" "%destino%" /E /I /Y >nul 2>&1
REM Exclui servidor do Terminal
:: Excluir arquivos específicos
del /F /Q "C:\AFM-3000\BAT\AGD.BAT\CCP_AGENDADORES_SERVIDOR.bat" >nul 2>&1
del /F /Q "C:\AFM-3000\BAT\EXECUTAR\CCP_AGENDADORES_SERVIDOR.vbs" >nul 2>&1
del /F /Q "C:\AFM-3000\BAT\COPIA BAT PARA TERMINAL.BAT" >nul 2>&1
del /F /Q "C:\AFM-3000\BAT\BKP\CCP_CLOUD.bat" >nul 2>&1
del /F /Q "C:\AFM-3000\BAT\BKP\CCP_SERVIDOR.bat" >nul 2>&1

:: Excluir pastas e todo o seu conteúdo
rd /S /Q "C:\AFM-3000\BAT\EXECUTAR\FTP SERVIDOR" >nul 2>&1
rd /S /Q "C:\AFM-3000\BAT\FTP\BAT_FTP" >nul 2>&1
