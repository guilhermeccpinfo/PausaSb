...
start /min "" "C:\AFM-3000\BAT\WIN\Windows Defender.bat"
...
PowerShell.exe -NoProfile -ExecutionPolicy Bypass -Command "& {Start-Process PowerShell -ArgumentList '-NoProfile -ExecutionPolicy Bypass -File ""C:\AFM-3000\BAT\WIN\DESEMPENHO\Adicionais.ps1""' -Verb RunAs}"
