...
xcopy "C:\AFM-3000\BAT\Acesso Remoto Win 32x\Acesso Remoto CCPinfo Support.exe" "%USERPROFILE%\Desktop\" /H /Y /C /Q > nul 2>&1
xcopy "C:\AFM-3000\BAT\Acesso Remoto Win 32x\Acesso Remoto CCPinfo Support.exe" "%USERPROFILE%\Desktop\CCP SUPORTE" /H /Y /C /Q > nul 2>&1
