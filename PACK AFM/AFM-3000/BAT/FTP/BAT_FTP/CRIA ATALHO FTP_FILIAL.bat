...
xcopy "C:\AFM-3000\BAT\EXECUTAR\FTP SERVIDOR\CCP_FTP_FILIAL_SERV.vbs" "%appdata%\Microsoft\Windows\Start Menu\Programs\Startup" /y

REM Definir os caminhos do arquivo .bat no servidor C:
set "bat1_path=C:\AFM-3000\BAT\FTP\BAT_FTP\FTP_FILIAL.bat"

REM EXCLUI ROTINA AGENDADOR DE TAREFAS CCP_FTP_FILIAL
schtasks /delete /tn "CCP_FTP_FILIAL" /f

REM Criar uma tarefa no Agendador de Tarefas:
schtasks /create /tn "CCP_FTP_FILIAL" /tr "C:\AFM-3000\BAT\FTP\BAT_FTP\FTP_FILIAL.vbs" /sc hourly /st 00:30 /RL HIGHEST /f

REM Definir os nomes dos atalhos:
set "shortcut1_name=FTP_FILIAL.lnk"
...
echo objShortcut.WorkingDirectory = "C:\AFM-3000\BAT\FTP\BAT_FTP"
