...
::set "exe3_path=\\%server_name%\CCPWIN\CCPWIN.exe"

REM Definir os nomes dos atalhos
set "shortcut1_name=GERENCIA.lnk"
set "shortcut2_name=TERMINAL06.lnk"
::set "shortcut3_name=CCPWIN.lnk"
...
::echo objShortcut.WorkingDirectory = "%server_name%\CCPWIN\" >> "%TEMP%\CreateShortcut3.vbs"
