...
echo SGL-3000 by CCPinfo - Por favor aguarde, estamos verificando a conexao com o seu servidor...
echo -------------------------------------------------------------------------------------------
...
REM Definir os caminhos dos quatro arquivos .exe no servidor Z:
set "exe1_path=Z:\SGL-3000\Gerencia.exe"
set "exe2_path=Z:\SGL-3000\Boca.exe"
set "exe3_path=Z:\SGL-3000\Boca.exe"
set "exe4_path=Z:\SGL-3000\Boca.exe"
::set "exe5_path=\\%server_name%\CCPWIN\CCPWIN.exe"

REM Definir os nomes dos atalhos
set "shortcut1_name=GERENCIA.lnk"
set "shortcut2_name=BOCA.lnk"
set "shortcut3_name=CAIXA.lnk"
set "shortcut4_name=TERMINAL.lnk"
::set "shortcut5_name=CCPWIN.lnk"
...
echo objShortcut.WorkingDirectory = "Z:\SGL-3000" >> "%TEMP%\CreateShortcut1.vbs"
...
echo objShortcut.WorkingDirectory = "Z:\SGL-3000" >> "%TEMP%\CreateShortcut2.vbs"
...
echo objShortcut.WorkingDirectory = "Z:\SGL-3000" >> "%TEMP%\CreateShortcut3.vbs"
echo objShortcut.Save >> "%TEMP%\CreateShortcut3.vbs"
cscript "%TEMP%\CreateShortcut3.vbs"
...
echo objShortcut.WorkingDirectory = "Z:\SGL-3000" >> "%TEMP%\CreateShortcut4.vbs"
echo objShortcut.Save >> "%TEMP%\CreateShortcut4.vbs"
cscript "%TEMP%\CreateShortcut4.vbs"
del "%TEMP%\CreateShortcut4.vbs"

::REM ATALHO GERENCIA CCPWIN
...
::echo objShortcut.WorkingDirectory = "%server_name%\CCPWIN\" >> "%TEMP%\CreateShortcut5.vbs"
