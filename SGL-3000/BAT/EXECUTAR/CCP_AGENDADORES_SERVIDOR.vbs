...
sourceFile = "C:\SGL-3000\BAT\EXECUTAR\CCP_AGENDADORES_SERVIDOR.vbs"
...
command = "powershell.exe -Command Start-Process cmd.exe -ArgumentList '/c C:\SGL-3000\BAT\AGD.BAT\CCP_AGENDADORES_SERVIDOR.BAT' -Verb RunAs -WindowStyle Hidden"
