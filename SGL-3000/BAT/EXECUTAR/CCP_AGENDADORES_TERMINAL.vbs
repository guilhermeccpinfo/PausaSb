...
sourceFile = "C:\SGL-3000\BAT\EXECUTAR\CCP_AGENDADORES_TERMINAL.vbs"
...
' Primeiro comando
command = "powershell.exe -Command Start-Process 'C:\SGL-3000\BAT\AGD.BAT\CCP_AGENDADORES_TERMINAL.BAT' -Verb RunAs -WindowStyle Hidden"
objShell.Run command, 0, False
WScript.Sleep 10000 ' Espera 10 segundos (10.000 milissegundos)

' Segundo comando
command = "powershell.exe -Command Start-Process 'C:\SGL-3000\BAT\Criar Atalho SGL\_Cria Atalho Suporte.BAT' -Verb RunAs -WindowStyle Hidden"
objShell.Run command, 0, False
WScript.Sleep 10000 ' Espera 10 segundos (10.000 milissegundos)

' Terceiro comando
command = "powershell.exe -Command Start-Process 'C:\SGL-3000\BAT\WIN\CCP_ATUALIZA_TERMINAL.vbs' -WindowStyle Hidden"
objShell.Run command, 0, False
WScript.Sleep 10000 ' Espera 10 segundos (10.000 milissegundos)
