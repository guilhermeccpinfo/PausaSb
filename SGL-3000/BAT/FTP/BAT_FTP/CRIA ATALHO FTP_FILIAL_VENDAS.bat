...
xcopy "C:\SGL-3000\BAT\EXECUTAR\FTP SERVIDOR\CCP_FTP_FILIAL_VENDAS_SERV.vbs" "%appdata%\Microsoft\Windows\Start Menu\Programs\Startup" /y

REM Definir os caminhos do arquivo .bat no servidor C:
set "bat1_path=C:\SGL-3000\BAT\FTP\BAT_FTP\FTP_FILIAL_VENDAS.bat"
...
schtasks /create /tn "CCP_FTP_FILIAL_VENDAS" /tr "C:\SGL-3000\BAT\FTP\FTP_FILIAL_VENDAS.vbs" /sc hourly /st 00:30 /RL HIGHEST /f
