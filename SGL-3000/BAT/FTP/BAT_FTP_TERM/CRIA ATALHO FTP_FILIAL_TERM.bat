...
xcopy "C:\SGL-3000\BAT\EXECUTAR\FTP TERMINAL\CCP_FTP_FILIAL_TERM.vbs" "%appdata%\Microsoft\Windows\Start Menu\Programs\Startup" /y

REM Definir os caminhos do arquivo .bat no servidor C:
set "bat1_path=Z:\SGL-3000\BAT\FTP\BAT_FTP\FTP_FILIAL.bat"
...
echo objShortcut.WorkingDirectory = "Z:\SGL-3000\BAT\FTP\BAT_FTP"
