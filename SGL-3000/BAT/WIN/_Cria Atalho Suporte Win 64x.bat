...
echo IconResource=C:\SGL-3000\BAT\IMAGEM\ICONCCP.ico,0 >> "%USERPROFILE%\Desktop\CCP SUPORTE\desktop.ini"
...
echo IconFile=C:\SGL-3000\BAT\IMAGEM\ICONCCP.ico >> "%userprofile%\Desktop\CCP SUPORTE\CHAT SUPORTE.url"
...
echo IconFile=C:\SGL-3000\BAT\IMAGEM\ICONCCP.ico >> "%userprofile%\Desktop\CHAT SUPORTE.url"
...
echo IconFile=C:\SGL-3000\BAT\IMAGEM\ICONCCP.ico >> "%userprofile%\Desktop\CCP SUPORTE\BASE CONHECIMENTO.url"
...
echo IconFile=C:\SGL-3000\BAT\IMAGEM\ICONCCP.ico >> "%userprofile%\Desktop\CCP SUPORTE\YOUTUBE CCPinfo.url"
echo IconIndex=0 >> "%userprofile%\Desktop\CCP SUPORTE\YOUTUBE CCPinfo.url"

echo CRIANDO ACESSO REMOTO
xcopy "C:\SGL-3000\BAT\Acesso Remoto Win 64x\Acesso Remoto CCPinfo Support.exe" "%USERPROFILE%\Desktop\" /H /Y /C /Q > nul 2>&1
xcopy "C:\SGL-3000\BAT\Acesso Remoto Win 64x\Acesso Remoto CCPinfo Support.exe" "%USERPROFILE%\Desktop\CCP SUPORTE" /H /Y /C /Q > nul 2>&1
exit